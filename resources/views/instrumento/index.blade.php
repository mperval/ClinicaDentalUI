                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('instrumentos.destroy',$instrumento->id) }}" method="POST">
                                            <a class="btn btn-sm btn-primary " href="{{ route('instrumentos.show',$instrumento->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                            <a class="btn btn-sm btn-success" href="{{ route('instrumentos.edit',$instrumento->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                            @csrf
                                            @method('DELETE')
