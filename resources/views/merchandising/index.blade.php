                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('merchandisings.destroy',$merchandising->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('merchandisings.show',$merchandising->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('merchandisings.edit',$merchandising->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
